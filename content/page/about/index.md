...
Biological Science, Zhejiang University, [Colleage of Life Sciences](http://www.cls.zju.edu.cn/clscn/)

**PhD student (2022\~ )**:

Bioinformatics, Zhejiang University, [Life Sciences Institute](http://lsi.zju.edu.cn/)
...
<img align="right" width="30%" src="images/titan.jpg" />
...
- 📩 Please contact [pengchen2001\@zju.edu.cn](mailto:pengchen2001@zju.edu.cn) or [bfzede\@gmail.com](mailto:bfzede@gmail.com).
...
4.  Q. Chen, M. Yuan, L. Jiang, X. Wei, Z. Liu, **C. Peng**, Z. Huang, D. Tang, X. Wu, J. Sun, C. Ye, Q. Liu, X. Zhu, P. Gao, L. Huang, M. Wang, M. Jiang, C. Jiang, Progressive community, biogeochemical and evolutionary remodeling of the soil microbiome underpins long-term desert ecosystem restoration. *bioRxiv* \[Preprint\] (2023). <https://doi.org/10.1101/2023.09.26.559499>.
5.  H. Wu, **C. Peng**, M. Chen, Rethinking the complexity and uncertainty of spatial networks applied to forest ecology. *Scientific Reports* (2022). <https://doi.org/10.1038/s41598-022-16485-9>.
6.  L. Fan, **C. Peng**, X. Zhu, Y. Liang, T. Xu, P. Xu, S. Wu, Dihydrotanshinone I Enhances Cell Adhesion and Inhibits Cell Migration in Osteosarcoma U−2 OS Cells through CD44 and Chemokine Signaling. *Molecules* (2022). <https://doi.org/10.3390/molecules27123714>.
7.  X. Zhu, T. Xu, **C. Peng**, S. Wu, Advances in MALDI Mass Spectrometry Imaging Single Cell and Tissues. *Frontiers in Chemistry* (2022). <https://doi.org/10.3389/fchem.2021.782432>.
8.  M. Xia, Y. Liu, J. Liu, D. Chen, Y. Shi, Z. Bai, Y. Xiao, **C. Peng**, J. Si, P. Li, Y. Qiu, A new synonym of Polygonatum in China, based on morphological and molecular evidence. *PhytoKeys* (2021). <https://doi.org/10.3897/phytokeys.175.63383>.
...
1.  [pcutils](https://github.com/Asa12138/pcutils)
    ...
    -   See the [Github page](https://asa12138.github.io/pcutils/) for the HTML documentation.
...
4.  [ReporterScore](https://github.com/Asa12138/ReporterScore)
    ...
    -   See the [Github page](https://asa12138.github.io/ReporterScore/) for the HTML documentation.

5.  [plot4fun](https://github.com/Asa12138/plot4fun)

    -   `plot4fun` provides many interesting functions for plotting.
    
    -   See the [Github page](https://asa12138.github.io/plot4fun/) for the HTML documentation.

## Web servers 🕸

1.  [iPhylo](https://iphylo.net/)

    -   It is a comprehensive, automated, and interactive platform for biological and chemical taxonomic analysis, developed in cooperation with [Li Yueer](https://github.com/ARise-fox).

    -   See the [iPhylo Tutorial](https://bookdown.org/Asa12138/iphylo_tutorial/) for more details.
