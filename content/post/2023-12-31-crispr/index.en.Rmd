...
CRISPR整体工作流程基本如下 @carterSnapShotCRISPRRNAGuidedAdaptive2015：
...
@makarovaSnapShotClassCRISPRCas2017，而2类CRISPR-Cas系统利用**单一蛋白效应器**
@makarovaSnapShotClassCRISPRCas2017a。
...
一篇比较新的综述总结讨论了 CRISPR-Cas 系统的一些众所周知的和一些最近建立的非规范功能及其在其他生物过程中的快速扩展应用 @deviCRISPRCasSystemsRole2022。它们在基因调控、细菌病理生理学、毒力和进化中的替代作用已经开始揭示。
...
CRISPR-Cas 系统存在于大约 40% 的细菌和 85% 的古细菌基因组中，但不存在于真核生物基因组中。最近，Communications Biology 上发表的一篇文章报道了在人类基因组中鉴定出 12,572 个推定的 CRISPR，他们称之为“hCRISPR” @vanrietCRISPRsHumanGenome2022。

觉得有点搞笑，人类怎么会有这么多CRISPR系统，所以又看到一篇文章怼他的： @buyukyorukClarifyingCRISPRWhy2023。
