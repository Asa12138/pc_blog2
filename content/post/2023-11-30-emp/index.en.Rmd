...
原文链接： https://www.nature.com/articles/nature24621 (*Nature* 2017 @thompsonCommunalCatalogueReveals2017)
...
现在的16S rRNA测序分析用的更多的是ASV (amplicon sequence variant) @callahanExactSequenceVariants2017，符合使用准确序列这一倡议，可以参考 https://www.jianshu.com/p/f31581bbfb80。
...
1. A macroecological theory of microbial biodiversity @shoemakerMacroecologicalTheoryMicrobial2017
...
2. Standardized multi-omics of Earth’s microbiomes reveals microbial and metabolite diversity @shafferStandardizedMultiomicsEarth2022
...
3. Earth microbial co-occurrence network reveals interconnection pattern across microbiomes @maEarthMicrobialCooccurrence2020
