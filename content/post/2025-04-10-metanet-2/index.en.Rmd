...
![](images/pairwise_relationship.png)
...
![](images/2-1.time_memory.png)

`c_net_calculate`的计算速度比其他R包快得多，特别是在特征数量很大的情况下：

![](https://bookdown.org/Asa12138/metanet_book/02-construction_files/figure-html/fig-2-packages-comparison-1.png)
...
kbl(data.frame(df, check.names = F), escape = F,format = "pipe") 
```
...
![](https://bookdown.org/Asa12138/metanet_book/images/2-1.RMT.png){width=80%}
...
![](https://bookdown.org/Asa12138/metanet_book/images/2-2.RMT.png)

可以在`RMT_threshold()`中设置gif=TRUE并获取gif文件，以观察不同r阈值下特征值间距的分布。

![](https://bookdown.org/Asa12138/metanet_book/images/2-3.rmt_nnsd.gif){width=70%}
